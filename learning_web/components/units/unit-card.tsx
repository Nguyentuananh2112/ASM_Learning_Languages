...
// Định nghĩa kiểu props cho UnitCard
...
// Component hiển thị một unit học (bài học)
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-x-4">
        ...
        {/* Nút hành động cho unit: START, CONTINUE, LOCKED */}
        <Button
      ...
      {/* Nếu đã hoàn thành unit thì hiển thị icon check */}
      {completed && (
